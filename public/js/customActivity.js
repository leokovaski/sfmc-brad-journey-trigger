        ...
        payload.arguments.execute.inArguments = [
            {
                ...
                selectedJourneyName: selectedJourneyName || 'Nenhuma jornada selecionada.',
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (journeys.length === 0) {
                    $('#loading-message').text('Nenhuma jornada com origem de entrada de "evento de API" foi encontrada.');
                } else {
            ...
            error: function (xhr, status, error) {
                ...
                $('#loading-message').text('Erro ao carregar jornadas. Tente novamente.');
            }
        });
    }
